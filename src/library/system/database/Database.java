...
public class Database {
    ...
    public void createTable() throws SQLException {
        String sql1 = "create table if not exists lbdb.books (id int primary key auto_increment,title varchar(255),author varchar(255),publisher varchar(255),available boolean default true)";
        Statement stmt1 = conn.createStatement();
        stmt1.execute(sql1);
        
        String sql2 = "create table if not exists lbdb.members (id int primary key auto_increment,name varchar(40),mobile varchar(50),address varchar(255))";
